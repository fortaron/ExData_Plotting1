...
par(mfrow = c(2, 2)) # Set the distribution of the canvas
...
# Plot 2 of 4
plot(housesub$Voltage ~ as.POSIXct(housesub$datetime),
...
# Plot 4 of 4
plot(housesub$Global_reactive_power ~ as.POSIXct(housesub$datetime),
